...
public class AddAnalysisDTO {
    ...
    public AddAnalysisDTO() {}
    
    public AddAnalysisDTO(int submissionId, String dataStructures, String algorithms, Float aiProbability, String aiFeedback) {
    ...
    public AddAnalysisDTO(String dataStructures, String algorithms, Float aiProbability, String aiFeedback) {
    	this.dataStructures = dataStructures;
    	this.algorithms = algorithms;
    	this.aiProbability = aiProbability;
    	this.aiFeedback = aiFeedback;
