...
public class AccountResponse {
	...
	public AccountResponse(int accountId, String handle, int platformId, String platformName, Timestamp addedDate, Timestamp lastCrawlDate, boolean isActive) {
    ...
    public String getPlatformName() { return plaformName; }
    public void setPlatformName(String plaformName) { this.plaformName = plaformName; }
